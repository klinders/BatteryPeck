# ==============================================================================
# isolated_callback_test.jl
# Diagnoses the Reactive TMS Callback without running the full 90-minute script
# ==============================================================================
...
println("Initialising Callback Diagnostic...")
...
println("Attaching Diagnostic DiscreteCallback...")
cb_baseline = build_baseline_callback(sys_simp.thermal_pack, 4, m_active, m_passive, 288.15, 298.15)
...
cb_all = CallbackSet(cb_baseline, cb_save)
...
display(plot(p1, p2, p3, layout=(3,1), size=(800, 800), title="Isolated Callback Trigger Test"))
println("Done! Only one simulation run will execute now.")