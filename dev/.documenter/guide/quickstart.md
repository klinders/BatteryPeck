...
- **View worked examples**: See [Examples](examples.md) for common simulation scenarios
...
### Run a multi-step experiment {#Run-a-multi-step-experiment}
...
### Use different parameter sets {#Use-different-parameter-sets}
...
### Increase model resolution {#Increase-model-resolution}
...
- See [Examples](examples.md) for real-world simulation scenarios
