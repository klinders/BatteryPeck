...
# Examples and Worked Scenarios {#Examples-and-Worked-Scenarios}

Practical examples showing common battery simulation use cases.

## Example 1: Simple Constant-Power Discharge {#Example-1:-Simple-Constant-Power-Discharge}
...
## Example 2: Multi-Step Charging and Discharging {#Example-2:-Multi-Step-Charging-and-Discharging}
...
## Example 3: Comparing Parameter Sets {#Example-3:-Comparing-Parameter-Sets}
...
## Example 4: Drive Cycle Simulation {#Example-4:-Drive-Cycle-Simulation}
...
## Example 5: Temperature Effects {#Example-5:-Temperature-Effects}
...
## Example 6: Long-Duration Cycling {#Example-6:-Long-Duration-Cycling}
...
### Adjust Solver Tolerances for Speed {#Adjust-Solver-Tolerances-for-Speed}
...
### Increase Model Resolution for Better Accuracy {#Increase-Model-Resolution-for-Better-Accuracy}
...
### Extract Specific Variables {#Extract-Specific-Variables}
...
### Save Results for Analysis {#Save-Results-for-Analysis}
