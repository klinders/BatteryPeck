...
# Side Reactions: SEI and Lithium Plating {#Side-Reactions:-SEI-and-Lithium-Plating}
...
## Solid Electrolyte Interface (SEI) {#Solid-Electrolyte-Interface-SEI}

### Formation and Growth {#Formation-and-Growth}
...
### SEI Models in BatteryToolkit {#SEI-Models-in-BatteryToolkit}
...
#### 2. ReactionLimitedSEI {#2.-ReactionLimitedSEI}
...
#### 3. SolventDiffusionLimitedSEI {#3.-SolventDiffusionLimitedSEI}
...
### Formation and Stripping {#Formation-and-Stripping}
...
### Lithium Plating Models {#Lithium-Plating-Models}

BatteryToolkit provides three plating implementations:

#### 1. NoPlating {#1.-NoPlating}
...
#### 2. IrreversiblePlating {#2.-IrreversiblePlating}
...
#### 3. PartiallyReversiblePlating {#3.-PartiallyReversiblePlating}
...
### Conservative Simulation (Fast) {#Conservative-Simulation-Fast}
...
### Realistic Simulation (Balanced) {#Realistic-Simulation-Balanced}
...
### High-Fidelity Simulation (Slow) {#High-Fidelity-Simulation-Slow}
...
### Abuse Scenario (Plating Risk) {#Abuse-Scenario-Plating-Risk}
...
## Impact on Battery Performance {#Impact-on-Battery-Performance}

### SEI Effects {#SEI-Effects}
...
### Plating Effects {#Plating-Effects}
...
### Accuracy vs Speed Trade-off {#Accuracy-vs-Speed-Trade-off}
